  ...
  return (
    <label className="block">
      ...
      <input
        ...
        onChange={onChange}
        disabled={disabled}
        className="mt-2 h-12 w-full rounded-lg border border-slate-200 bg-white px-4 text-sm font-medium text-slate-900 outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 disabled:bg-slate-50 disabled:text-slate-500"
      />
    </label>
  );
}
    ...
    <div className="block">
      ...
      <div className="relative mt-2">
        <input
          ...
          value={value}
          onChange={onChange}
          className="h-12 w-full rounded-lg border border-slate-200 bg-white px-4 pr-12 text-sm font-medium text-slate-900 outline-none transition placeholder:text-slate-500 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100"
        />
        <button
          type="button"
...
export default function ComplianceProfileSettings() {
  ...
  const [role, setRole] = useState("Compliance Team");
        ...
        <section className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Manage your compliance officer credentials, digital electronic signature, and security password.
            </p>
          </div>
        </section>
        ...
        <section className="border-b border-slate-200">
          <div className="flex gap-6 sm:gap-8 px-1 overflow-x-auto">
            ...
            >
              ...
              {isProfileTab ? (
                <span className="absolute inset-x-0 bottom-[-1px] h-0.5 rounded-full bg-emerald-700" />
              ) : null}
            </button>
        ...
        {isProfileTab && (
          <form onSubmit={handleSaveProfile} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            <h2 className="text-lg font-bold text-slate-950">
              Personal & Regulatory Identity
            </h2>
            <p className="text-xs text-slate-500 mt-0.5">
              These details identify your digital certification on compliance and regulatory audit logs.
            </p>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-8 inline-flex h-12 min-w-[200px] items-center justify-center rounded-xl bg-emerald-700 px-8 text-sm font-bold text-white shadow-sm transition hover:bg-emerald-800 disabled:opacity-50 cursor-pointer"
            >
        ...
        {isPasswordTab && (
          <form onSubmit={handleChangePassword} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            ...
            <p className="mt-1 text-xs text-slate-500">
              Protect regulatory compliance audit authority by maintaining high-entropy credentials.
            </p>
