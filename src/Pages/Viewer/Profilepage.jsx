  ...
  return (
    <Viewer>
      <div className="mx-auto max-w-[1500px] space-y-6">
        ...
        {error && (
          <div className="p-4 text-sm font-semibold text-red-700 bg-red-50 border border-red-200 rounded-lg">
            {error}
          </div>
        )}

        {successMessage && (
          <div className="p-4 text-sm font-semibold text-green-700 bg-green-50 border border-green-200 rounded-lg">
            {successMessage}
          </div>
        )}
        ...
        {isProfileTab ? (
          <form onSubmit={handleSaveProfile} className="max-w-5xl rounded-xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            ...
            <div className="mt-6 space-y-5">
              ...
              <label className="block opacity-60 cursor-not-allowed">
                ...
                <button
                  type="button"
                  disabled
                  className="mt-2 flex h-12 w-full items-center justify-between rounded-lg border border-slate-200 bg-slate-50 px-4 text-left text-sm font-medium text-slate-900 transition cursor-not-allowed"
                >
                  Viewer
                </button>
              </label>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-7 inline-flex h-13 min-w-[225px] items-center justify-center rounded-lg bg-blue-600 px-8 text-sm font-bold text-white shadow-sm transition hover:bg-blue-700 disabled:opacity-50"
            >
              {loading ? "Saving..." : "Save Changes"}
            </button>
          </form>
        ) : (
          <form onSubmit={handleChangePassword} className="max-w-5xl rounded-xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            <h2 className="text-xl font-bold text-slate-950">
              Change Password
            </h2>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-8 inline-flex h-13 min-w-[215px] items-center justify-center rounded-lg bg-blue-600 px-8 text-sm font-bold text-white shadow-sm transition hover:bg-blue-700 disabled:opacity-50"
            >
